...
public class InternalFrameGestorSubRubro extends JInternalFrame {
	 ...
	 */
	public InternalFrameGestorSubRubro() {
		super();
		initialize();
	}
	...
	public void setItemsInJtable(){
		...
		jTableSubRubro.getColumnModel().getColumn(0).setPreferredWidth(8);
		jTableSubRubro.getColumnModel().getColumn(1).setPreferredWidth(300);
	}
	...
	public int deleteItem(SubRubro subRubro){
		...
		try{
			...
			int selectedOption = JOptionPane.showConfirmDialog(null, "Desea Eliminar El SubRubro Seleccionado","Eliminar", JOptionPane.OK_CANCEL_OPTION);
			if(selectedOption == 0){
