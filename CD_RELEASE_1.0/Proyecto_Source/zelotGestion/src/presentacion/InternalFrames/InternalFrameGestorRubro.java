...
public class InternalFrameGestorRubro extends JInternalFrame {
	 ...
	 */
	public InternalFrameGestorRubro() {
		super();
		initialize();
	}
	...
	public void setItemsInJtable(){
		...
		jTableRubro.getColumnModel().getColumn(0).setPreferredWidth(8);
		jTableRubro.getColumnModel().getColumn(1).setPreferredWidth(300);
	}
