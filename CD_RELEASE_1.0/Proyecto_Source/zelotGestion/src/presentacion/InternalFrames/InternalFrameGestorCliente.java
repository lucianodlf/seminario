...
import presentacion.Dialog.DialogGestorCondVenta;
import presentacion.Dialog.DialogGestorCondicionIva;
import presentacion.Dialog.DialogGestorListasPrecio;
import presentacion.Dialog.DialogGestorLocalidad;
import presentacion.Dialog.DialogGestorProvincia;
import presentacion.Dialog.DialogGestorVendedor;
import presentacion.Dialog.DialogMovimientoCtaCte;
...
public class InternalFrameGestorCliente extends JInternalFrame {
	...
	private JButton jButtonaVerComprobantes = null;
	private JButton jButtonaVerCtaCte = null;
	 ...
	 */
	public InternalFrameGestorCliente() {
		super();
		initialize();
	}
	...
	private JToolBar getJToolBar() {
		if (jToolBar == null) {
			...
			jToolBar.add(getJButtonaVerComprobantes());
			jToolBar.addSeparator(new Dimension(10,10));
			jToolBar.add(getJButtonaVerCtaCte());
			jToolBar.addSeparator(new Dimension(10,10));
	...
	public void setEnabledButtonsToolbar(boolean btnNuevo, boolean btnModificar, boolean btnEliminar, boolean btnOk, boolean btnCancel, boolean btnCloce, boolean btnVerComp, boolean btnVerCtaCte){
		...
		jButtonaVerComprobantes.setVisible(btnVerComp);
		jButtonaVerCtaCte.setVisible(btnVerCtaCte);
	}
	...
	public void setEstatusAllComponent(boolean estado, boolean estadoTextBusqueda, boolean estadoComboBoxBusqueda, boolean estadoTableList){
		...
		//jTextFieldMovil.setEditable(true);
	}
	...
	/**
	 * This method initializes jButtonaVerComprobantes
	 *
	 * @return javax.swing.JButton
	 */
	private JButton getJButtonaVerComprobantes() {
		if (jButtonaVerComprobantes == null) {
			jButtonaVerComprobantes = new JButton();
			jButtonaVerComprobantes.setPreferredSize(new Dimension(100, 30));
			jButtonaVerComprobantes.setIcon(new ImageIcon(getClass().getResource("/Preview Docment_24x24.png")));
			jButtonaVerComprobantes.setText("Ver Comprobantes");
			jButtonaVerComprobantes.setBorderPainted(false);
			jButtonaVerComprobantes.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					System.out.println("actionPerformed()"); // TODO Auto-generated Event stub actionPerformed()
		...
		return jButtonaVerComprobantes;
	}

	/**
	 * This method initializes jButtonaVerCtaCte
	 *
	 * @return javax.swing.JButton
	 */
	private JButton getJButtonaVerCtaCte() {
		if (jButtonaVerCtaCte == null) {
			jButtonaVerCtaCte = new JButton();
			jButtonaVerCtaCte.setPreferredSize(new Dimension(100, 30));
			jButtonaVerCtaCte.setIcon(new ImageIcon(getClass().getResource("/Money_24x24.png")));
			jButtonaVerCtaCte.setText("Ver Cta. Cte.");
			jButtonaVerCtaCte.setBorderPainted(false);
			jButtonaVerCtaCte.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					System.out.println("actionPerformed()"); // TODO Auto-generated Event stub actionPerformed()
					if(cliente != null){
						DialogMovimientoCtaCte dialogMovimientoCtaCte = new DialogMovimientoCtaCte(new Frame(), cliente);
						dialogMovimientoCtaCte.setModal(true);
						dialogMovimientoCtaCte.setVisible(true);
					}
				}
			});
		}
		return jButtonaVerCtaCte;
	}
