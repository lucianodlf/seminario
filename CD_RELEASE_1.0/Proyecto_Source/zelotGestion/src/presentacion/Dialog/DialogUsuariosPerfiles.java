...
public class DialogUsuariosPerfiles extends JDialog {
	 ...
	 * @param owner
	 */
	public DialogUsuariosPerfiles(Frame owner) {
		super(owner);
		initialize();
	}
	...
	private JTabbedPane getJTabbedPaneUsuariosPerfiles() {
		if (jTabbedPaneUsuariosPerfiles == null) {
			...
			jTabbedPaneUsuariosPerfiles.setBounds(new Rectangle(5, 5, 400, 445));
	...
	private JPanel getJPanelPermisos() {
		if (jPanelPermisos == null) {
			...
			jPanelPermisos.setBounds(new Rectangle(408, 26, 230, 445));
	...
	private JToolBar getJJToolBarPermisos() {
		if (jJToolBarPermisos == null) {
			...
			jJToolBarPermisos.setBounds(new Rectangle(0, 395, 230, 30));
	...
	private JButton getJButtonAddUsuario() {
		if (jButtonAddUsuario == null) {
			...
			jButtonAddUsuario.setBounds(new Rectangle(10, 390, 80, 20));
	...
	private JButton getJButtonUpdateUsuario() {
		if (jButtonUpdateUsuario == null) {
			...
			jButtonUpdateUsuario.setBounds(new Rectangle(95, 390, 100, 20));
	...
	private JButton getJButtonDeleteUsuario() {
		if (jButtonDeleteUsuario == null) {
			...
			jButtonDeleteUsuario.setBounds(new Rectangle(200, 390, 80, 20));
	...
	private JButton getJButtonUsuarioGrabar() {
		if (jButtonUsuarioGrabar == null) {
			...
			jButtonUsuarioGrabar.setBounds(new Rectangle(250, 310, 100, 30));
	...
	private JButton getJButtonUsuarioCancelar() {
		if (jButtonUsuarioCancelar == null) {
			...
			jButtonUsuarioCancelar.setBounds(new Rectangle(250, 345, 100, 30));
	...
	private JButton getJButtonAddPerfil() {
		if (jButtonAddPerfil == null) {
			...
			jButtonAddPerfil.setBounds(new Rectangle(10, 390, 80, 20));
	...
	private JButton getJButtonUpdatePerfil() {
		if (jButtonUpdatePerfil == null) {
			...
			jButtonUpdatePerfil.setBounds(new Rectangle(95, 390, 100, 20));
	...
	private JButton getJButtonDeletePerfil() {
		if (jButtonDeletePerfil == null) {
			...
			jButtonDeletePerfil.setBounds(new Rectangle(200, 390, 80, 20));
