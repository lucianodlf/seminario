...
public class DialogVisorNotaCredito extends JDialog {
	 ...
	 */
	public DialogVisorNotaCredito(Frame owner, Factura fac) {
		super(owner);
		initialize(fac);
	}
	...
	private void initialize(Factura fac) {
		...
		this.setTitle("Visor de Notas de Crédito");
	...
	private void setDatosFactura(Factura fac){
		...
		if(fac.getNroComprobanteRelac() != null && fac.getNroPtoVtaComprobanteRelac() != null && fac.getLetraComprobanteRelac() != null && fac.getTipoComprobanteRelac() != null){
			jTextFieldFacNum.setText(fac.getNroPtoVtaComprobanteRelac()+"-"+fac.getNroComprobanteRelac());
		}
	...
	public void setEstatusAllComponent(boolean estadoCamposArticulos){
		...
		jButtonBuscarFactura.setEnabled(false);
		...
		jCheckBoxArticulo.setEnabled(false);
		jCheckBoxDetalle.setEnabled(false);
	}
	...
	private JCheckBox getJCheckBoxArticulo() {
		if (jCheckBoxArticulo == null) {
			...
			jCheckBoxArticulo.setText("Artículo");
		}
