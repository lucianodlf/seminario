...
public class DialogGestorProvincia extends JDialog {
	 ...
	 */
	public DialogGestorProvincia(Frame owner) {
		super(owner);
		initialize();
	}
	...
	public int deleteItem(Provincia provincia){
		int statusAction = 2; // 0=Exito | 1=Falso | 2=Error
		try{
			JOptionPane.showMessageDialog(null, "La Provincia Seleccionada Será Eliminada\n" +
					"Código: "+provincia.getCodigo()+"\n" +
					"Descripción: "+provincia.getNombre(),"Eliminar",JOptionPane.INFORMATION_MESSAGE);
